...
namespace CinemaTicketAdminApp.Controllers
{
    public class OrderController : Controller
    {
        ...
        public IActionResult Index()
        {
            ...
            string URL = "https://localhost:44364/api/Admin/GetOrders";
        ...
        public IActionResult Details(Guid id)
        {
            ...
            string URL = "https://localhost:44364/api/Admin/GetDetailsForTicket";
        ...
        public FileContentResult CreateInvoice(Guid id)
        {
            ...
            string URI = "https://localhost:44364/api/Admin/GetDetailsForTicket";
        ...
        public FileContentResult ExportAllOrders()
        {
            ...
            using (var workbook = new XLWorkbook())
            {
                ...
                string URI = "https://localhost:44364/api/Admin/GetOrders";
